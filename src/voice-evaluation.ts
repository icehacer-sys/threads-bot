...
export const VOICE_CASES = [
  ...
  { name: "image challenge", text: "Why does this child seem to have two left clavicles?", public: true, skip: true },
  { name: "operator question", text: "Are you a bot?", public: true, skip: true },
  { name: "personal advice", text: "My child is drooling. Should I get an X-ray?", public: true, skip: true },
